...
| Node                       | A place where multiple tracks join. They are determined by using the same segments after a node |
| Gap                        | A too big distance between two segments when they are used in a track                           |
