...
import {
    getBreakInsertionIndex,
    getTrackCompositions,
    getTrackIdForAddingABreak,
    trackMergeActions,
...
export const CreateBreakDialog = () => {
    ...
    const insertionIndex = useSelector(getBreakInsertionIndex);
    ...
    const addBreak = () => {
        ...
        segments.splice(insertionIndex ?? segments.length, 0, newBreak);
