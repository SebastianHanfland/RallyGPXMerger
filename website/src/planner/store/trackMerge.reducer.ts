...
const trackMergeSlice = createSlice({
    ...
    reducers: {
        ...
        setTracks: (state: TrackMergeState, action: PayloadAction<TrackComposition[]>) => {
            state.trackCompositions = action.payload;
        },
        ...
        setTrackStartName: (
            ...
            state.trackCompositions = state.trackCompositions.map((track) =>
                track.id === action.payload.id ? { ...track, startName: action.payload.startName } : track
            );
        },
