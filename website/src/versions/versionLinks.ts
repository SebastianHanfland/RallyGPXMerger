...
export const versions: Record<string, Variant[]> = {
    ...
    Sternfahrt2024: [
        {
            name: 'SF24_A95_final',
            url: 'https://sebastianhanfland.github.io/RallyGPXMerger/A95_DritterStandWebseite.json',
            mode: 'present',
        },
    ],
    ...
    KVR_24_A95_Vgl2_A7_8_9: [
        ...
        },
        {
            ...
            url: 'https://sebastianhanfland.github.io/RallyGPXMerger/A95_ZweiterStandWebsite.zip',
            color: 'green',
        },
    ],
    KVR_24_A95_Neuried: [
