    ...
    describe('aggregateEnrichedPoints', () => {
        it('should take to and from when ', () => {
            ...
            expect(aggregatedPoints).toEqual([
                {
                    streetName: 'Street A',
                    from: '2023-10-22T06:23:46Z',
                    to: '2023-10-22T06:23:46.000Z',
